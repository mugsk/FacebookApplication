...
<li><a href="" rel="tech"><img src="images/tech.png" width="50" height="50"/>TECHNOLOGY</a></li>
    ...
    <?	
			...
			if (!$connection) 
			{
				...
				$query = "SELECT * FROM bookreview ORDER BY time DESC";
...
<div  id="text">
		<div id="heading" style="background:#999; color:white;"><img src="images/book.png" width="50" height="50"/><b> BOOK REVIEWS</b></div>
...
<div id="text">
	<div id="heading" style="background:#999; color:white;"><img src="images/movie.jpg" width="50" height="50" /> <b> MOVIE REVIEWS</b></div>
	<?		    $query = "SELECT * FROM moviereview ORDER BY time DESC";
				$result = pg_query($connection, $query) or die("Error in query: $query. " . pg_last_error($connection));
...
<div id="text">
<div id="heading" style="background:#999; color:white;"><img src="images/restaurant.png" width="50" height="50"/><b> RESTAURANT REVIEWS</b></div>
				<? $query = "SELECT * FROM resreview ORDER BY time DESC";
				$result = pg_query($connection, $query) or die("Error in query: $query. " . pg_last_error($connection));
...
<div id="text">
		<div id="heading" style="background:#999; color:white;"><img src="images/tech.png" width="50" height="50"/><b> TECH REVIEWS</b></div>
				<?  $query = "SELECT * FROM techreview ORDER BY time DESC";
				$result = pg_query($connection, $query) or die("Error in query: $query. " . pg_last_error($connection));
